...
const PetCard = ({ pet, onClick, onEdit, onDelete }) => {
  ...
  const styleConfig = {
    ...
    avatar: {
      ...
      height: 56,
      marginRight: 16,
      backgroundColor: pet.imageUrl ? "transparent" : "#0e8d94",
    },
    profileButton: {
      position: "absolute",
      top: "50%",
    ...
    >
      ...
      >
        <CardContent style={{ display: "flex", alignItems: "center" }}>
          ...
          >
            {!pet.imageUrl && pet.nombre?.charAt(0).toUpperCase()}
          </Avatar>
          ...
          <div style={{ flex: 1 }}>
            ...
            <Typography variant="body2" color="textSecondary">
              Edad: {pet.edad ? `${pet.edad} años` : "No especificada"}
            </Typography>
          </div>
        </CardContent>
      </Box>
